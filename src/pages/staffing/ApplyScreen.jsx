...
<h1 style={{"fontFamily": "'Fraunces',serif", "fontVariationSettings": "'opsz' 144,'SOFT' 0,'WONK' 0", "fontWeight": "500", "fontSize": "34px", "color": "#171A20", "lineHeight": "1.15"}}>{"Application saved."}</h1>
<p style={{"fontSize": "16px", "color": "#5D6472", "marginTop": "12px", "lineHeight": "1.6"}}>{applyJobTitle}{" — "}{applyJobMeta}{". Your application is stored in your account. Recruiter notifications are not yet connected."}</p>
...
<li style={{"display": "flex", "gap": "13px"}}><span style={{"width": "26px", "height": "26px", "borderRadius": "50%", "background": "#22262E", "color": "#fff", "fontSize": "13px", "fontWeight": "600", "display": "flex", "alignItems": "center", "justifyContent": "center", "flexShrink": "0"}}>{"1"}</span><span style={{"fontSize": "14.5px", "color": "#262A33", "lineHeight": "1.55"}}>{"Your application is saved. Open your dashboard to see its reference and submission date."}</span></li>
<li style={{"display": "flex", "gap": "13px"}}><span style={{"width": "26px", "height": "26px", "borderRadius": "50%", "background": "#22262E", "color": "#fff", "fontSize": "13px", "fontWeight": "600", "display": "flex", "alignItems": "center", "justifyContent": "center", "flexShrink": "0"}}>{"2"}</span><span style={{"fontSize": "14.5px", "color": "#262A33", "lineHeight": "1.55"}}>{"Keep your contact details and credentials ready for a future review."}</span></li>
<li style={{"display": "flex", "gap": "13px"}}><span style={{"width": "26px", "height": "26px", "borderRadius": "50%", "background": "#22262E", "color": "#fff", "fontSize": "13px", "fontWeight": "600", "display": "flex", "alignItems": "center", "justifyContent": "center", "flexShrink": "0"}}>{"3"}</span><span style={{"fontSize": "14.5px", "color": "#262A33", "lineHeight": "1.55"}}>{"You can continue browsing and save other jobs that interest you."}</span></li>
</ol>
</div>
